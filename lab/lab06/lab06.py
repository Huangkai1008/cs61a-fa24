...
class BankAccount:
    ...
    def balance(self, value: int):
        ...
        after = value
        self.make_transaction(before, after)
        self._balance = value
    ...
    def make_transaction(self, before: int, after: int) -> Transaction:
        tx_id = len(self.transactions)
        tx = Transaction(tx_id, before, after)
...
class Email:
    ...
    def __init__(self, msg: str, sender, recipient_name):
        self.msg = msg
        self.sender = sender
